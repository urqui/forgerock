 ...
 * @since AM 5.5.0
 */
public class URQUiCollectorNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(URQUiCollectorNodePlugin.currentVersion, 
				Collections.singletonList(URQUiDecisionNode.class));
	}
	...
	public String getPluginVersion() {
		return URQUiCollectorNodePlugin.currentVersion;
	}
}
