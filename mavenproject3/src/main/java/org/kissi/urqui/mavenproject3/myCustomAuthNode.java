...
package org.kissi.urqui.mavenproject3;
...
public class myCustomAuthNode extends AbstractDecisionNode {
    ...
    private final static String DEBUG_FILE = "myCustomAuthNode";
     ...
     */
    @Inject
    public myCustomAuthNode(@Assisted Config config, CoreWrapper coreWrapper) throws NodeProcessException {
        this.config = config;
