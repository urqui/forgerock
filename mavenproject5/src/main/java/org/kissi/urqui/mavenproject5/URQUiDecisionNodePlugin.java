 ...
 * @since AM 5.5.0
 */
public class URQUiDecisionNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(URQUiDecisionNodePlugin.currentVersion, 
	...
	public String getPluginVersion() {
		return URQUiDecisionNodePlugin.currentVersion;
	}
}
